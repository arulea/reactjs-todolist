...
function App() {
  ...
  function addTask(event){
    ...
    if(newTask.current.value == ''){
      alert('Silahkan masukkan hal akan kamu kerjakan');
      return false
    }
    const data = {
      id: setId(),
  ...
  function remove(id){
    if(window.confirm('Yang bener maw hapus?')){
  ...
  return (
    <>
      ...
      <ToDoList tasks={tasks} setCompeleted={setCompeleted} move={move} remove={remove} />
    </>
  )
}
